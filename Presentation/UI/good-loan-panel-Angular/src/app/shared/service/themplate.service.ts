...
export class them {
  ...
  public DefaultCurrency: String = 'تومان';
  ...
  public PagSizeInvaite: number[] = [50, 70, 100, 150];
  //----------------------------------------------------------
  ...
  constructor() {
    ...
    if (!window.location.host.includes('localhost:4300') && window.location.host.includes('localhost')) {
