...
var ReportViewerComponent = (function (_super) {
    ...
    function ReportViewerComponent(el, cdRef, _ejIterableDiffers, _ejkeyvaluediffers) {
        ...
        _this.parameterUpdateStateChange_output = new core_2.EventEmitter();
        return _this;
    }
...
ReportViewerComponent.propDecorators = {
    ...
    'showExceptionsInDialog_input': [{ type: core_2.Input, args: ['showExceptionsInDialog',] },],
    ...
    'exportSettings_pptFormat_input': [{ type: core_2.Input, args: ['exportSettings.pptFormat',] },],
    ...
    'parameterUpdateStateChange_output': [{ type: core_2.Output, args: ['parameterUpdateStateChange',] },],
};
