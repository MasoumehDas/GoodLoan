import { OnInit, EventEmitter, Renderer2, SimpleChanges, OnChanges } from '@angular/core';
import { ControlValueAccessor } from '@angular/forms';
import { CommandExecutorService } from './common/services/command-executor.service';
import { MessageService } from './common/services/message.service';
export declare class NgxEditorComponent implements OnInit, ControlValueAccessor, OnChanges {
    ...
    uploadImage: EventEmitter<HTMLInputElement>;
    textArea: any;
    ngxWrapper: any;
    Utils: any;
    private onChange;
